...
/*  https://github.com/wythe1208/ICM-20689
 *
 *
 */

//-----------------------------------
// Define pin and port for ICM_20689 (adjust as needed)
#define ICM_20689_GPIO_PORT GPIOA
...
void icm20689_reset()
{
	ICM20689_Write_Reg(PWR_MGMT_1,0X80);	//��λ
	HAL_Delay(100);
	ICM20689_Write_Reg(PWR_MGMT_1, 0x00);	//�������״̬
}
//����DMP��ʼ���汾
...
{	
	...
	ICM20689_Write_Reg(GYRO_CONFIG,3<<3);//���������������̷�Χ
	ICM20689_Write_Reg(ACCEL_CONFIG,0<<3);//���ٶȼƹ�����Χ 2G
	ICM20689_Write_Reg(ACCEL_CONFIG_2, 0x08);//���ټƸ�ͨ�˲�Ƶ�� ����ֵ ��0x08  ��1.13kHz��	
	
	ICM20689_Write_Reg(SMPLRT_DIV,19);
	ICM20689_Write_Reg(CONFIG,4);					//��ͨ�˲�Ƶ�ʣ�����ֵ��0x07(3600Hz)�˼Ĵ����ھ���Internal_Sample_Rate==8K
	
	ICM20689_Write_Reg(MPU_INT_EN_REG,0X00);	//�ر������ж�
	ICM20689_Write_Reg(MPU_FIFO_EN_REG,0X00);	//�ر�FIFO
	
	ICM20689_Write_Reg(PWR_MGMT_1,0X01);	//����CLKSEL,PLL X��Ϊ�ο�
	ICM20689_Write_Reg(PWR_MGMT_2,0X00);	//���ٶ��������Ƕ�����
	

	return 0;
}
//ע�ⵥλ-----ʹ��dmpģʽʱ���ٶ�����һ���� +/- 4g
